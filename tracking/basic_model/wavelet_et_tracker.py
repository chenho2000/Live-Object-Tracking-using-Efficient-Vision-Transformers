...
class WAVE_ET_Tracker(Super_model_DP):
    ...
    def __init__(self, linear_reg=True, 
                    ...
                    temperature=1,
                    dropout=False):
        super(WAVE_ET_Tracker, self).__init__()
        ...
        self.cls_branch_2 = wavit.Block(dim=outchannels_cls, num_heads=e_exemplars, mlp_ratio=4)
        self.cls_branch_3 = wavit.Block(dim=outchannels_cls, num_heads=e_exemplars, mlp_ratio=4)
        self.cls_branch_4 = wavit.Block(dim=outchannels_cls, num_heads=e_exemplars, mlp_ratio=4)
        self.cls_branch_5 = wavit.Block(dim=outchannels_cls, num_heads=e_exemplars, mlp_ratio=4)
        ...
        self.bbreg_branch_2 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
        self.bbreg_branch_3 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
        self.bbreg_branch_4 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
        self.bbreg_branch_5 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
        self.bbreg_branch_6 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
        self.bbreg_branch_7 = wavit.Block(dim=outchannels_reg, num_heads=e_exemplars, mlp_ratio=4)
    ...
    def forward(self, template, search, label=None, reg_target=None, reg_weight=None):
        ...
        c = self.cls_branch_2(c.view(batch, channel, height*width).permute(0, 2, 1), height, width)
        c = self.cls_branch_3(c, height, width)
        c = self.cls_branch_4(c, height, width)
        c = self.cls_branch_5(c, height, width)
        ...
        b = self.bbreg_branch_2(b.view(batch, channel, height*width).permute(0, 2, 1), height, width) 
        b = self.bbreg_branch_3(b, height, width) 
        b = self.bbreg_branch_4(b, height, width) 
        b = self.bbreg_branch_5(b, height, width) 
        b = self.bbreg_branch_6(b, height, width) 
        b = self.bbreg_branch_7(b, height, width) 
